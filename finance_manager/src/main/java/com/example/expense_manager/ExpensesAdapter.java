...
public class ExpensesAdapter extends RecyclerView.Adapter<ExpensesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.note.setText(expenseModel.getNoteId());
        holder.category.setText(expenseModel.getCategoryId());
        holder.amount.setText(String.valueOf(expenseModel.getAmount()) + " INR");
    ...
    public class  MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            note=itemView.findViewById(R.id.noteRow);
            category=itemView.findViewById(R.id.categoryRow);
